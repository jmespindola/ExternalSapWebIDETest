sap.ui.define([
		...
		return BaseObject.extend("capu.model.ListSelector", {
			 ...
			 * @return {capu.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
